...
% Mostrar somente MES e ANO. Caso queria data completa basta colocar \today
\data{\ifcase \month\or Janeiro\or Fevereiro\or Março\or Abril\or Maio\or Junho\or Julho\or Agosto\or Setembro\or Outubro\or Novembro\or Dezembro\fi, \number\year}

\orientador{Prof. Dr. Nome Orientador}
...
\begin{figure}
    \centering
	\includegraphics[scale=0.3]{figuras/ufc-brasao.pdf} % altere o atributo scale para ajustar o tamanho
\end{figure}
...
\input{components/introducao}

\input{components/trabalhos_relacionados}

\input{components/objetivos}

\input{components/fundamentacao_teorica}

\input{components/metodologia}

\input{components/resultados_preliminares}
